...
export class ChatboxAIAPIError extends BaseError {
  static codeNameMap: { [codename: string]: ChatboxAIAPIErrorDetail } = {
    ...
    serpapi_api_key_required: {
      name: 'serpapi_api_key_required',
      code: 20025,
      i18nKey:
        'You have selected SerpAPI as the search provider, but an API key has not been entered yet. Please <OpenExtensionSettingButton>click here to open Settings</OpenExtensionSettingButton> and enter your API key, or choose a different search provider.',
    },
